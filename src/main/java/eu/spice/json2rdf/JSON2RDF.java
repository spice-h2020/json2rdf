...
public class JSON2RDF {
	...
	public static void main(String[] args) {
		try {
			...
			options.addOption(new Option("s", "syntax", true, "OPTIONAL - The RDF of the output file. [Default: TTL]"));
			...
			options.addOption(new Option("r", "resource-prefix", true,
					"OPTIONAL - The namespace prefix for the resources to be generated. [Default: https://w3id.org/spice/resource/]"));
			options.addOption(
			...
			String resourcePrefix = cmd.getOptionValue("r", "https://w3id.org/spice/resource/");
			...
			if (resourcePrefix != null && cmd.hasOption("n")) {
				bnt.setResourcePrefix(resourcePrefix);
			}
